    ...
    <section class="post">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <img src="{{asset('storage/images/'.$analysis->photo)}}" alt="" class="img-fluid mb-3" />
                    <small class="text-muted">{{$analysis->author}} - {{$analysis->created_at->format('d-m-Y')}}</small>
                    <div class="category-list d-flex my-4">

                        @foreach($analysis->arrayTags as $tag)
