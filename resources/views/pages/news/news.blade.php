...
@section('content')
    ...
    <section class="post">
      <div class="container">
        <div class="row">
          <div class="col-md-9">
            <img src="{{asset('storage/images/'.$news->photo)}}" alt="" class="img-fluid mb-3" />
            <small class="text-muted">{{$news->author}} - {{$news->created_at->format('d-m-Y')}}</small>
            <div class="category-list d-flex my-4">

                @foreach($news->arrayTags as $tag)
