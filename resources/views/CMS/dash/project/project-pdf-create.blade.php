...
@section('title', 'Project Pdf Create')

@section('content')
    <div class="container" style="padding-top: 1%;">
        <h1>Add Pdf to Project</h1>
        <hr>
        <div class="row">
            <div class="col-md-12 personal-info">
                ...
                <form class="form-horizontal" role="form" method="POST" action="/project-store-pdf" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                        <input type="hidden" name="publicationId" value="{{$project->id}}">
                    </div>
                    <div class="form-group">
