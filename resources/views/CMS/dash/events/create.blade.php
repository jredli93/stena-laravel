    ...
    <div class="container" style="padding-top: 1%;">
        ...
        <div class="row">
            <div class="col-md-12 personal-info">
                ...
                <form class="form-horizontal" role="form" method="POST" action="/store-event" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Author</label>
                        <div class="col-lg-12">
                            <input class="form-control" name="author" type="text" placeholder="Enter Author" value="eacs" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Event Status<font color="#ce1827">*</font></label>
                        <div class="col-lg-8">
