    ...
    <div class="container" style="padding-top: 1%;">
        ...
        <div class="row">
            <div class="col-md-12 personal-info">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('update.podcast') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Title <font color="#ce1827">*</font></label>
                        <div class="col-lg-12">
                            <input class="form-control" name="title" type="text" value="{{$podcast->title}}" placeholder="Enter Title" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Guest <font color="#ce1827">*</font></label>
                        <div class="col-lg-12">
                            <input class="form-control" name="guest" type="text" value="{{$podcast->guest}}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Video URL </label>
                        <div class="col-lg-12">
                            <input class="form-control" name="video" value="{{$podcast->video}}" type="text" placeholder="Enter Video Link">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Text <font color="#ce1827">*</font></label>
                        <div class="col-lg-12">
                            <textarea class="description" name="text">{{$podcast->text}}</textarea>
                        </div>
                    </div>
                    <div>
