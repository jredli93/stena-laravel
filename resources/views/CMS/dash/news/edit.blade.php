    ...
    <div class="container" style="padding-top: 1%;">
        ...
        <div class="row">
            <div class="col-md-12 personal-info">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('update.news', $news->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Author</label>
                        <div class="col-lg-12">
                            <input class="form-control" name="author" type="text" placeholder="Enter Author" value="{{$news->author}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <input class="form-control" name="title" type="text" value="{{$news->title}}" placeholder="Enter Title" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">News Status<font color="#ce1827">*</font></label>
                        <div class="col-lg-8">
                            <select name="status" class="col-lg-3 control-label">
                                <option value="{{$news->status}}" >{{ucfirst($news->status)}}</option>
                    ...
                    <div class="form-group">
                        ...
                        @if($news->photo)
                            <label class="col-lg-3 control-label">
                                <a href="{{asset('storage/images/'.$news->photo)}}" target="_blank">
                                    See current image
                                </a>
                            </label>
                        @endif
                    ...
                    <div class="form-group">
                        ...
                        @if($news->pdf)
                            <label class="col-lg-3 control-label">
                                <a href="{{asset('storage/pdf/'. $news->pdf)}}">
                                    See current pdf
                                </a>
                            </label>
                        @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" name="tags" type="text" placeholder="news,politics" value="{{$news->tags}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Short description <font color="#ce1827">*</font></label>
                        <div class="col-lg-12">
                            <textarea class="description" rows="5" cols="50" name="description" required>{{$news->description}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Text <font color="#ce1827">*</font></label>
                        <div class="col-lg-12">
                            <textarea id="text" class="description" required name="text">{{$news->text}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
