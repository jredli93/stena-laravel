...
@section('title', 'Team Member Pdf Create')

@section('content')
    <div class="container" style="padding-top: 1%;">
        <h1>Add Pdf to Team Member</h1>
        <hr>
        <div class="row">
            <div class="col-md-12 personal-info">
                ...
                <form class="form-horizontal" role="form" method="POST" action="/team-member-store-pdf" enctype="multipart/form-data">
                    @csrf
